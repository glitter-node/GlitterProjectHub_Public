...
class PageAttachmentService
{
    ...
    public function upload(
        ...
        $this->lifecycle->logLifecycle('accepted', 'page', $attachment);
        FinalizeAttachmentUploadJob::dispatch('page', $attachment->id);
        $this->lifecycle->logLifecycle('queued', 'page', $attachment);
