...
describe('NotificationCenter (glitter-project_hub)', () => {
  describe('기본 렌더링', () => {
  ...
  describe('이벤트 핸들러', () => {
    ...
    it('드롭다운을 열 때만 onRefresh가 호출됨', () => {
      ...
      render(<NotificationCenter onRefresh={onRefresh} />);

      expect(onRefresh).not.toHaveBeenCalled();
      expect((window as any).G7Core.navigation.onComplete).not.toHaveBeenCalled();
